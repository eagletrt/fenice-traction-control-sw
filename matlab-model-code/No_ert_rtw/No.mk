###########################################################################
## Makefile generated for component 'No'. 
## 
## Makefile     : No.mk
## Generated on : Tue Jul 26 10:36:15 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/No
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/No
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/No_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=No -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/No_ert_rtw/No.c

MAIN_SRC = $(START_DIR)/No_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/No_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/No_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
No.o : $(START_DIR)/No_ert_rtw/No.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/No_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
