...
## 
## Makefile     : Slip.mk
## Generated on : Tue Jul 26 10:42:28 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Slip
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Slip
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Slip_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Slip -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Slip_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Slip_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Slip.o : $(START_DIR)/Slip_ert_rtw/Slip.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Slip_data.o : $(START_DIR)/Slip_ert_rtw/Slip_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Slip_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
