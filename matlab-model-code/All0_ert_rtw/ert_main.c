...
void rt_OneStep(RT_MODEL *const rtM)
{
  ...
  /* Step the model */
  All0_step(rtM, rtU_Driver_req, rtU_u_bar, rtU_omega_rr, rtU_omega_rl,
            rtU_yaw_rate, rtU_Steeringangle, rtU_Brake, rtU_Tm_rl, rtU_Tm_rr,
            rtU_map_tv, rtU_map_sc, &rtY_Tm_rr, &rtY_Tm_rl);
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  All0_initialize(rtM, &rtU_Driver_req, &rtU_u_bar, &rtU_omega_rr, &rtU_omega_rl,
