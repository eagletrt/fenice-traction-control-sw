...
## 
## Makefile     : All0.mk
## Generated on : Tue Jul 26 10:41:36 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/All0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/All0
...
DEFINES_STANDARD = -DMODEL=All0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/All0_ert_rtw/All0.c $(START_DIR)/All0_ert_rtw/All0_data.c

MAIN_SRC = $(START_DIR)/All0_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/All0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/All0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
All0.o : $(START_DIR)/All0_ert_rtw/All0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


All0_data.o : $(START_DIR)/All0_ert_rtw/All0_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/All0_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
