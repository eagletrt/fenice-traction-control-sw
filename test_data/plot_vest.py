...
if __name__ == '__main__':
    e, a = read_files('test_data/vest/vel_output_prova1.csv', 'test_data/vest/vel_test_output1.csv')
    plot(e, a)
    e, a = read_files('test_data/vest/vel_output_prova2.csv', 'test_data/vest/vel_test_output2.csv')
    plot(e, a)